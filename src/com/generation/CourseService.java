...
public class CourseService
{
    ...
    public void displayStudentInformation(String studentId){
    	System.out.println("name: "+students.get(studentId).getName()+"Id: " +students.get(studentId).getId() );
    	students.get(studentId).enrolledCourses.forEach(t ->System.out.println("course:"+t.name));
    
    }
    
    public int totalCredits(String studentId) {
    	int n= 0;
    	List<Course> lista = students.get(studentId).enrolledCourses;
